...
restab(9,i)=N;        % (ions.m^(-3))Densité d’ions Er3+
restab(10,i)=Sep;     % (m2)Section efficace d’émission de la pompe @ 980 nm 
restab(11,i)=Gp;      % (sd)Facteur de recouvrement entre le mode de la pompe et l’aire dopée
restab(12,i)=Gs;      % (sd)Facteur de recouvrement entre le mode du signal et l’aire dopée
restab(13,i)=Aeff;    % (m2)Aire de la zone dopée
restab(14,i)=ap;      % (m^-1)Pertes linéiques de la pompe
restab(15,i)=as;      % (m^-1)Pertes linéiques de la sonde
